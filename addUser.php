...
if (isset($_POST['submit'])) {
  ...
  $sql = "insert into products (product_name, price, quantity, image, expiry_date, description) values ('$product_name', '$price', '$QTY', '$product_image', '$expiry_date', '$description')";
      ...
      <form method="POST" action = "">
        <div class="form-row">
            <div class="col-md-6">
              ...
              <input class="form-control text-center" type="text" name="username" placeholder="" >
    </div>
    <div class="col-md-6">
              <label for="userEmail">User Email</label>
              <input class="form-control text-center" name="email" type="text" placeholder="">
    </div>
    <div class="col-md-6">
              <label for="userContact">Contact</label>
              <input class="form-control text-center" type="text" name="contact" placeholder="  ">
    </div>
    <div class="col-md-6">
              <label for="address">Address</label>
              <input class="form-control text-center" type="text" name="address" placeholder="" >
    </div>
    <div class="col-md-6">
              <label for="password">password</label>
              <input class="btn btn-outline-success form-control" type="password" name="userPassword">
    </div>
    <div class="col-md-6">
              <label for="userRole">Role</label>
              <input class="form-control text-center" type="text" name="role" placeholder="  ">
    </div>

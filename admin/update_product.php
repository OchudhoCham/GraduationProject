...
if (isset($_POST['submit'])) {
  ...
  $sql = "update products set product_id=".$row['product_id'].", product_name='$product_name', price='$price', quantity='$QTY', image='$product_image', expiry_date='$expiry_date', description='$description' where product_id=".$row['product_id']." ";
  $result = mysqli_query($conn, $sql);
  if ($result) {
